...
<li>Avoiding adverse and negative reporting to the credit bureaus such as late monthly payments or payment gaps which destroy your credit.</li>
                      ...
                      <p>
                      The Short Sale Management Center (SSMC) offers short sale processing and closing services to homeowners, commercial property owners, real estate professionals and intermediaries nationwide. We are a one-stop, short sale processing center that negotiates the best short sale terms and lender incentives on behalf of distressed homeowners, commercial property owners and investor/equity stakeholders.
                      </p>
                      ...
                      <blockquote>
                        ...
                        <p>
                          <ul class="blockquote_list">
                            <li>Pre-Foreclosure Advisory Services</li>
                            <li>Deed-In-Lieu (DIL) Solutions</li>
                            <li>Investor Deed-For-Lease Programs</li>
                            <li>Quick Listing & Sale Transactions</li>
                            <li>Loan Workout, Restructuring or Refinance </li>
                            <li>Negotiated Cash-For-Keys Incentives with Relocation </li>
                            <li>Assistance</li>
                    ...
                    <div class="span5">
                      <blockquote>
                        ...
                        <p>
                          <ul class="blockquote_list">
                            <li>Accelerated Short Sale Closings</li>
                            <li>Reinstatement & Repayment Plans</li>
                            <li>Distressed Lending Programs </li>
                            <li>Foreclosure Alternative Strategies</li>
                            <li>Permanent Loan Modifications </li>
